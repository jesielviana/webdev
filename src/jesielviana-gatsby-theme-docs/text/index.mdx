...
### Acessando este conteúdo offline

Este site foi construindo no padrão PWA - Progressive Web App.

PWA possibilita que você adicione este site direto na tela inicial do seu celular para utilizá-lo como um aplicativo nativo, inclusive offline, para isso basta acessar esta página pelo seu celular, em seguida:
